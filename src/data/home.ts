  ...
  services: [
    {
      ...
      description:
        "Helping seniors and adults remain socially engaged through conversation, companionship, activities, and emotional support.",
    },
    {
      title: "Personal Care Assistance",
      description:
        "Support with daily activities such as grooming, dressing, mobility assistance, and personal hygiene.",
    },
    {
      title: "Transportation Services",
      description:
        "Reliable transportation to medical appointments, errands, community activities, and other destinations.",
    },
  ],
};
