...
export const serviceAreas = [
  { 
    ...
    aboutBody: [
      ...
      "Whether your family requires a few hours of weekly companion care, reliable transportation to local medical appointments, or round-the-clock specialized assistance, our dedicated Santa Rosa team is here. We carefully match our caregivers to provide absolute peace of mind for your entire family."
    ]
  },
  { 
    name: "Rohnert Park", 
    ...
    aboutBody: [
      ...
      "From light housekeeping and joyful companionship to complex 24/7 personal care, our highly trained caregivers take a holistic approach to senior wellness. Let us provide the relief and professional support your family deserves."
    ]
  },
  { 
    name: "Petaluma", 
    ...
    aboutBody: [
      ...
      "Our flexible service options range from hourly respite care for exhausted family members to comprehensive live-in support. We take pride in carefully pairing each client with a caregiver who matches their personality and care requirements perfectly."
    ]
  },
  { 
    name: "Napa", 
    ...
    aboutBody: [
      ...
      "Whether you are looking for temporary transitional care after a hospital stay or long-term daily assistance, our expert care coordinators are available 24/7 to build a plan that brings comfort to your loved one and peace of mind to you."
    ]
  },
  { 
    name: "Vacaville", 
    ...
    aboutBody: [
      ...
      "From running errands and preparing nutritious meals to offering specialized support for mobility limitations, our meticulously screened caregivers are ready to step in. Let us carry the caregiving load so you can focus on spending quality time with your family."
    ]
  },
  { 
    name: "Fairfield", 
    ...
    aboutBody: [
      ...
      "Whether your loved one simply needs a friendly face for weekly companionship or requires intensive 24/7 monitoring for fall prevention, our team is dedicated to delivering consistent, heartfelt support."
    ]
  },
  { 
    name: "San Rafael", 
    ...
    aboutBody: [
      ...
      "We offer highly flexible scheduling. Whether you need overnight awake care, daily transportation to Marin County medical facilities, or simply a few hours of respite, we are here to craft the perfect care solution."
    ]
  },
  { 
    name: "Martinez", 
    ...
    aboutBody: [
      ...
      "If your family is navigating the complexities of aging, recovery, or chronic conditions, our dedicated coordinators are ready to help. We match you with caregivers who bring empathy, professionalism, and genuine companionship into the home."
    ]
  },
  { 
    name: "Concord", 
    ...
    aboutBody: [
      ...
      "Every client is unique, which is why we never use a one-size-fits-all approach. We offer customized scheduling—from hourly companionship to 24-hour continuous care—to ensure your family receives exactly the right level of support."
    ]
  },
  { 
    name: "Berkeley", 
    ...
    aboutBody: [
      ...
      "Whether transitioning home after a hospital stay or managing age-related decline, our expertly trained team is here. We handle the demanding aspects of caregiving so you can return to simply being a son, daughter, or spouse."
    ]
  },
  { 
    name: "Walnut Creek", 
    ...
    aboutBody: [
      ...
      "Our services are entirely adaptable to your shifting needs. Whether you require temporary support during a family vacation or long-term, 24/7 specialized assistance, our team is equipped to deliver exceptional care."
    ]
  },
  { 
    name: "San Francisco", 
    ...
    aboutBody: [
      ...
      "We understand that urban living requires flexibility and reliability. Our care team is available around the clock to provide customized companionship, personal care, and specialized support tailored to the unique pace of your loved one’s life."
    ]
  },
  { 
    name: "Oakland", 
    ...
    aboutBody: [
      ...
      "Whether you need short-term respite care to recharge your own batteries, or you are seeking comprehensive 24/7 support for a loved one with complex needs, our carefully matched professionals are ready to help."
    ]
  },
  { 
    name: "Daly City", 
    ...
    aboutBody: [
      ...
      "We work closely with local families to build care plans that truly fit. From a few hours of friendly companionship to comprehensive overnight monitoring, we provide the reliable safety net your family needs."
    ]
  },
  { 
    name: "Hayward", 
    ...
    aboutBody: [
      ...
      "If you are feeling overwhelmed by the demands of caring for an aging relative, our flexible care solutions are here for you. We provide perfectly matched caregivers to ensure your loved one receives consistent, compassionate attention."
    ]
  },
  { 
    name: "San Mateo", 
    ...
    aboutBody: [
      ...
      "We recognize that inviting a caregiver into your home is a major decision. Our rigorous screening and thoughtful matching process ensures that your family receives support from someone who is not only skilled, but genuinely compassionate."
    ]
  },
  { 
    name: "Pleasanton", 
    ...
    aboutBody: [
      ...
      "Our tailored services accommodate any schedule. Whether your loved one requires occasional transportation and errand-running, or comprehensive 24/7 living assistance, our dedicated team is prepared to meet your exact needs."
    ]
  },
  { 
    name: "San Bruno", 
    ...
    aboutBody: [
      ...
      "We are committed to easing the burden on family caregivers. With options ranging from hourly respite care to full-time support, we provide the peace of mind that comes from knowing your loved one is in capable, caring hands."
    ]
  },
  { 
    name: "Milpitas", 
    ...
    aboutBody: [
      ...
      "Whether you are coordinating a discharge from a local medical facility or simply noticing that your parent needs extra help around the house, our 24/7 care coordinators are ready to match you with the perfect caregiving professional."
    ]
  },
  { 
    name: "Palo Alto", 
    ...
    aboutBody: [
      ...
      "From providing a few hours of sharp, attentive companionship each week to delivering complex 24-hour care, Glorious Home Care Assistance provides unparalleled support tailored to your family's exact lifestyle and needs."
    ]
  },
  { 
    name: "San Jose", 
    ...
    aboutBody: [
      ...
      "Whether your loved one needs reliable transportation to appointments in the South Bay, engaging daily companionship, or vigilant overnight monitoring, our rigorously vetted care professionals are here to provide absolute peace of mind."
    ]
  },
  { 
    name: "Santa Clara", 
    ...
    aboutBody: [
      ...
      "From short-term respite care to intensive 24/7 personal assistance, we tailor every aspect of our service. Let our expert care coordinators design a plan that keeps your loved one safe, comfortable, and thoroughly supported at home."
    ]
  },
  { 
    name: "Mountain View", 
    ...
    aboutBody: [
      ...
      "We are dedicated to supporting not just the client, but the entire family. Whether you need an experienced caregiver to manage overnight needs or a friendly companion for afternoon walks, we have the perfect professional ready to assist."
    ]
  },
  { 
    name: "Sunnyvale", 
    ...
    aboutBody: [
      ...
      "Every care plan we create is entirely unique. Whether your loved one requires highly attentive personal hygiene assistance or simply a trusted partner for daily errands, our matched caregivers ensure they feel safe and respected at all times."
    ]
  },
  { 
    name: "Cupertino", 
    ...
    aboutBody: [
      ...
      "Whether you are seeking relief from family caregiving duties through our flexible hourly services, or you require comprehensive 24/7 living support, Glorious Home Care Assistance delivers unmatched reliability and compassion."
    ]
  },
  { 
    name: "Campbell", 
    ...
    aboutBody: [
      ...
      "We recognize that care needs can change rapidly. Our flexible scheduling ensures that whether you need temporary transitional support or long-term personal assistance, a highly qualified caregiver is always available to help."
    ]
  },
  { 
    name: "Los Gatos", 
    ...
    aboutBody: [
      ...
      "From a few hours of weekly support to 24/7 comprehensive care monitoring, Glorious Home Care Assistance is dedicated to bringing your family ultimate peace of mind and your loved one the highest quality of daily life."
    ]
  }
];