        ...
        <Container className="grid gap-12 py-20 md:grid-cols-[1.1fr_1fr] md:items-center md:gap-16 md:py-24">
          ...
          <Reveal className="flex flex-col items-start">
            ...
            <div className="mb-8 space-y-4 text-lg leading-relaxed text-muted">
              {/* Maps through your intro paragraphs, or provides a clean fallback if not defined in data */}
              {faqIntro?.paragraphs ? (
      ...
      <section className="bg-white border-y border-white">
        <Container className="py-16 md:py-24">
          ...
          <div className="mb-12 text-center flex flex-col items-center">
            <Reveal>
              <h3 className="mb-4 text-3xl font-extrabold text-brand-ink md:text-4xl">Explore by Topic</h3>
          ...
          <div className="mx-auto max-w-4xl space-y-12">
            {faqCategories.map((category, index) => (
              <Reveal key={category.categoryTitle} delay={index * 0.1}>
                <div className="rounded-3xl border border-white bg-white p-6 shadow-sm sm:p-10 transition-shadow hover:shadow-md">
